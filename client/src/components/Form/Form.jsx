      ...
      <div className="p-5 sm:w-96 w-full flex-col justify-start items-center ">
        <form autoComplete="off" onSubmit={handleSubmit} >
          <div className="text-white pb-2 font-mono text-2xl">{currentId ? `Edit ${post.title}!` : 'Post it!'}</div>
            ...
            <input placeholder="tags" name="tags" value={postData.tags} type="text" onChange={(e) => setPostData({ ...postData, tags: e.target.value.split(',') })} className="my-2 w-full flex-initial p-3 outline-none bg-gray-50 text-black border-none text-sm white-glassmorphism rounded-lg font-mono" />  
